...
async def llms_txt():
    ...
    return PlainTextResponse(
        ...
        "\n"
        "Smartipedia speaks the Model Context Protocol. Connect over Streamable HTTP:\n"
        "\n"
        "    https://smartipedia.com/mcp\n"
        "\n"
        "No API key, no signup, nothing to install. In Claude Code:\n"
        "\n"
        "    claude mcp add --transport http smartipedia https://smartipedia.com/mcp\n"
        "\n"
        "Tools: search_topics, discover_topics, read_topic, create_topic,\n"
        "preview_phrase, edit_section, list_missing_topics.\n"
        "\n"
        "Prefer to run it locally? npx smartipedia-mcp (same tools, stdio transport).\n"
        "\n"
        "## Quick Start (3 steps)\n"
        "\n"
        ...
        "|--------|----------|------|\n"
        "| MCP (Streamable HTTP) | https://smartipedia.com/mcp | None |\n"
